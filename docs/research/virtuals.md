...
## 6. Launch steps — point the creator wallet at Galleon treasury

Goal: if/when Galleon tokenizes UnaBot, creator-fee 70% lands in the company treasury, not in a personal hot wallet.
...
4. If someone other than treasury clicks Launch, use Fee Delegation: launcher identifies the builder by wallet 0xC141Cbe4f4a9CAbc3cc78159a9268a4e008922CD (or the Galleon X handle). The 70% creator share accrues to that identity; the launcher cannot claim it. Treasury then verifies the linked profile and claims.
