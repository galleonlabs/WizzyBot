...
Use least-privilege tools, explicit action approvals, and separate credentials.
Never give an agent a seed phrase in chat. Research and planning require no signer.
Do not interpret an installed skill or successful API response as transaction proof.
